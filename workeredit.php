...
<body>
  ...
  <main id="main">
    ...
    <div class="container">
        ...
        <div class="content">
            <form action="workereditsec.php" method="POST">
              <div class="user-details">
                <div class="input-box">
                  <span class="details">First Name</span>
                  <input type="text" name="first" value="<?php echo $user_data2['first_name'];?>" required>
                </div>
                <div class="input-box">
                  <span class="details">Last Name</span>
                  <input type="text" name="second" value="<?php echo $user_data2['last_name'];?>" required>
                </div>
                <div class="input-box">
                  <span class="details">Email</span>
                  <input type="text" name="mail" value="<?php echo $user_data2['email'];?>" required>
                </div>
                <div class="input-box">
                  <span class="details">Phone Number</span>
                  <input type="text" name="phno" value="<?php echo $user_data2['phone'];?>" required>
                </div>
                <div class="input-box">
                  <span class="details">Address</span>
                  <input type="text" name="add" value="<?php echo $user_data2['address'];?>" required>
                </div>
                <div class="input-box">
                  <span class="details">Place</span>
                  <input type="text" name="place" value="<?php echo $user_data2['place'];?>" required>
                </div>
