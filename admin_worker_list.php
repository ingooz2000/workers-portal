...
<main id="main">
  ...
  <section id="about" class="about">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="mb-4">
                    <label for="filterInput">Search worker:</label>
    ...
    foreach ($workers as $worker) {
        ...
        if ($filterTerm !== '' && stripos($worker['id'], $filterTerm) === false) {
            continue;
        }
        $dataFound = true;
                ...
                <div class="col-auto">
                    ...
                    <div class="col-lg-5">
                        <div class="candidate-list-content mt-3 mt-lg-0">
                            <h5 class="fs-19 mb-0">
                            <a class="primary-link" href="#"><?php echo $worker['firstname'] . ' ' . $worker['secondname'];?></a>  <span class="rating-box"><i class="mdi mdi-star align-middle"></i>4.8</span>
                            </h5>
                            
                            <ul class="list-inline mb-0 text-muted">
                                <li class="list-inline-item"><i class="mdi mdi-map-marker"></i> ID:<?php echo $worker['id'];?></li>
                                <li class="list-inline-item"><i class="mdi mdi-map-marker"></i> Place:<?php echo $worker['place'];?></li>
                                <li class="list-inline-item"><i class="mdi mdi-wallet"></i> Contact:<?php echo $worker['phone'];?></li>
                                <li class="list-inline-item"><i class="mdi mdi-map-marker"></i> Mail:<?php echo $worker['email'];?></li>
                            </ul>
                            <form action="worker_remove.php" method="post">
