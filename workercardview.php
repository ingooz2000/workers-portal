...
<header id="header">
  <div class="d-flex flex-column">
    ...
    <div class="profile">
      ...
      <h1 class="text-light"><a href="index.html"><?php  echo $user_data2['first_name'].' '.$user_data2['last_name']; ?></a></h1>
                    ...
                    <div class="col-lg-5">
                        <div class="candidate-list-content mt-3 mt-lg-0">
                            ...
                            <ul class="list-inline mb-0 text-muted">
                                ...
                                <li class="list-inline-item"><i class="mdi mdi-map-marker"></i> ID:<?php echo $contractor['id'];?></li>
                            </ul>

                            <form action="request.php" method="post">
                            <input type="hidden" name="contractor_id" value="<?php echo $contractor['id']; ?>">
                            <button type="submit" class="btn btn-primary mt-3" name="submit_request">Request Approval</button>
                            </form>
                        </div>
                    </div>
                </div>
